  ...
  return (
    ...
    >
      ...
      {compact ? (
        ...
        <div className="absolute inset-x-0 bottom-0 flex justify-center bg-gradient-to-t from-black/50 to-transparent p-4 sm:p-5">
          <span className="max-w-[85%] truncate rounded-full bg-white/15 px-4 py-1.5 text-sm font-semibold text-white backdrop-blur-sm sm:px-5 sm:py-2 sm:text-lg">
            {profile.spiritAnimal}
          </span>
        </div>
      )}
