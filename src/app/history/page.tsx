    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 px-4 py-10 sm:px-6 sm:py-14">
        <div className="flex flex-col gap-3">
          <h1 className="font-heading text-3xl font-semibold tracking-tight sm:text-4xl">Your Result History</h1>
          <p className="max-w-2xl text-muted-foreground">
            Saved locally on this device — every assessment you complete is added here automatically.
          </p>
        </div>
        <HistoryList />
      </main>
